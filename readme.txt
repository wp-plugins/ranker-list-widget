...
3. Place generated short codes in your posts.
...
= Why do I have to rebuild short codes when some settings change? =

With the Ranker widget we've tried to be as flexible as possible for site creators. Because of this you can put our widget in any size layout with your choice of rows, our code will recalculate your widget to look just right based on those settings.

Once you have working shortcodes in your pages changing some default settings then requires you to recalculate those codes. Changing width, rows to display or display of username will change the height of your widget and that may leave the CSS a little messy in existing widgets. Recalculating those URLs will help to keep everything looking tip-top!
